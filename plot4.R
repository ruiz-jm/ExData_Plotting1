...
par(mfrow=c(2,2))
plot(as.numeric(hpc$Global_active_power),type='l',ylab='Global Active Power',xlab='', xaxt="n")
axis(1  , at=c(1, len, len2), labels=c("Thu", "Fri", "Sat"))

plot(as.numeric(hpc$Voltage),type='l',ylab='Voltage',xlab='datetime', xaxt="n")
axis(1  , at=c(1, len, len2), labels=c("Thu", "Fri", "Sat"))
...
legend("topright",cex=0.5, c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), fill=c("black","blue","red"))
axis(1  , at=c(1, len, len2), labels=c("Thu", "Fri", "Sat"))


plot(as.numeric(hpc$Global_reactive_power),type='l',ylab='Global Reactive Power',xlab='datetime', xaxt="n")
axis(1  , at=c(1, len, len2), labels=c("Thu", "Fri", "Sat"))
